<template>
    ...
    >
        ...
        <div class="text-left">
            <h6 class="titulo-modal">Selecciona la localización</h6>
        </div>
        <hr />
        ...
        <div class="d-block">
            ...
            >
                ...
                <MglMarker :coordinates="locationMarcador" color="red" />
            </MglMap>
            ...
            <div class="form-row">
                ...
                <b-button variant="primary" class="boton-si" @click="cargar()"
                    >Cargar datos</b-button
                >
            </div>
        </div>
