<template>
    ...
    >
        ...
        <div class="body-advertencia">
            <h6 class="tituloagregar">Agregar configuración</h6>
            <hr />
            <div class="row">
                <div class="col-12 col-md-6">
                    <label class="float-left" for="inputParametro"
                        >Tipo de parámetro</label
                    >

                    <select class="form-control" id="inputParametro">
                ...
                <div class="col-12 col-md-6">
                    <label class="float-left" for="inputValor">Valor</label>
                    <input
                        id="inputValor"
                        type="text"
                        class="form-control"
...
<script>
    export default {
        data() {
            return {
                mensaje: "¿Estas seguro que deseas cerrar Bo Calefacción?",
                accion: false,
            };
        },
        methods: {
