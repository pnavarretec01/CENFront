    ...
    <div>
        <div>
            ...
            <b-breadcrumb class="float-right mt-3 bread">
                ...
                <b-breadcrumb-item active>Pellet</b-breadcrumb-item>
            </b-breadcrumb>
        </div>
        <h2 class="titulo mt-5">Pellet</h2>
        <b-card class="main-card mb-4">
            <h5 class="card-title">
                Listado de puntos de venta de pellet a nivel nacional
            </h5>
            <div class="row">
    ...
    export default {
        ...
        methods: {
            exportarExcel() {
                if (this.data.exportar == "excel") {
                    ...
                    saveExcel({
                        ...
                        fileName: "puntoventa_pellet_" + this.fecha,
                        columns: [
                            {
                                field: "nombre",
            ...
            generarPdf() {
                ...
                doc.setFontSize(12);
                doc.text("Puntos de venta Pellet", 40, 40);
                doc.autoTable(columns, vm.data.datos, {
                    margin: { top: 60 },
                });
                doc.save("puntos_VentaPellet_" + this.fecha);
                this.data.exportar = "";
            },
            agregarEmpresa() {
