<template>
    <div>
        ...
        <b-card class="main-card mb-4">
            <h5 class="card-title">
                Listado de parámetros configurado para leña
            </h5>
            <div class="row">
...
<script>
    ...
    import ModalAgregarConfiguracion from "../../../Components/Leña/Configurar/ModalAgregarConfiguracion.vue";
    ...
    export default {
        ...
        methods: {
            exportarExcel() {
                if (this.data.exportar == "excel") {
                    ...
                    saveExcel({
                        ...
                        fileName: "ParametrosLeña_" + this.fecha,
                        columns: [
                            {
            ...
            generarPdf() {
                ...
                doc.text("Parámetros Leña", 40, 40);
                doc.autoTable(columns, vm.data.datos, {
                    margin: { top: 60 },
                });
                doc.save("parametrosLeña_" + this.fecha);
                this.data.exportar = "";
            },
            agregarConfModal() {
