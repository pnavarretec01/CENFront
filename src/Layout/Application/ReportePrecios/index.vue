    ...
    <div>
        <div>
            ...
            <b-breadcrumb class="float-right mt-3 bread">
                ...
                <b-breadcrumb-item active>Reporte de precios</b-breadcrumb-item>
            </b-breadcrumb>
        </div>
        <h2 class="titulo mt-5">Reporte de precios</h2>
        <b-card class="main-card mb-4">
            <h5 class="card-title">
                Habilite o deshabilite el reporte de precios de un combustible
            </h5>
            <Tabla
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            obtenerCombustibles() {
                axios
                    .get(this.$root.urlApi + "reportes/listar")
                    .then((res) => {
            ...
            eliminar(row, index, e) {},
            checkboxX(row, index, e) {
                axios
                    .put(this.$root.urlApi + "reportes/habilitar", row)
                    .then((res) => {
                        if (res.data.code == 401) {
                            this.$toastr.Add({
                                msg: "No se ha completado la acción, inicie sesión nuevamente y reintente",
